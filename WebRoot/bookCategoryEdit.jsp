...
<html>
  <head>
    ...
    <title>My JSP 'bookCategoryEdit.jsp' starting page</title>
  ...
  <body>
    ...
    <nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
	    ...
	    <li class="breadcrumb-item active" aria-current="page">Edit BookCategory</li>
	  </ol>
	</nav>
    <div class="container">
    <h2>This is edit BookCategory page.</h2> <br>
