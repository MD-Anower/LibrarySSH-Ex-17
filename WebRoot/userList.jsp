...
<html>
  ...
  <body>
    <nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
	    <li class="breadcrumb-item"><a href="#">UserList Manage	</a></li>
	 ...
	 <div class="container">
     	...
     	<button class="btn btn-info" onclick="search();">search</button> 
   		<button class="btn btn-success" id="add_hw" onclick="add();">add User</button>
   	 </div>  
	<div class="container">
	...
	<script type="text/javascript">
		function search(){
			...
			window.location.href = "userAction_query?keyWord=" + keyWord;
		}
		
		function del(id){
			if(confirm("Are you sure to delete the record?")){
				window.location.href = "userAction_delete?id=" + id;
			}
		}
		
		function add(){
			window.location.href = "userAction_showAdd";
		}
